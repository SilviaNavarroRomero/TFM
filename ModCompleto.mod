...
subject to
{
   ...
   forall (g in Grup, d in Dias, h in Hor: g in Grup5HS){
	...
	forall(p in Docentes)
	 ...
	 // 13. 9.40 Horas puntas contrato: Las quito por ahora porque me hacen tardar el problema 40 min
...
{SolHorarioCurso} SolHorarioDep={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["Departamento"][d][h]==1};
{SolHorarioCurso} SolHorarioTut={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["Tutores"][d][h]==1};
{SolHorarioCurso} SolHorarioGua={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["Guardias"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1A={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1ESOA"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1B={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1ESOB"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1Desdoble={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1ESODesdoble"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2A={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2ESOA"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2B={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2ESOB"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2PMAR={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2PMAR"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso3PMAR={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["3PMAR"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1BTOA={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1BTOA"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1BTOB={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1BTOB"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1BTOC={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1BTOC"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso1BTOD={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["1BTOD"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2BTOA={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2BTOA"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2BTOB={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2BTOB"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2BTOC={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2BTOC"][d][h]==1};
{SolHorarioCurso} SolHorarioCurso2BTOD={<d,h+1,a.nombre,p>|d in Dias, h in Hor, a in HorasAsignaturas, p in Docentes: x[p][a]["2BTOD"][d][h]==1};
...
{SolHorarioProf} SolHorarioProfP1={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P1"][a][g][d][h]==1};
//{SolHorarioProf} SolHorarioProfP3={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P3"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP4={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P4"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP5={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P5"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP6={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P6"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP7={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P7"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP8={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P8"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP9={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P9"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP10={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P10"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP11={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P11"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP12={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P12"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP13={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P13"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP14={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P14"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP15={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P15"][a][g][d][h]==1};

{SolHorarioProf} SolHorarioProfP19={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P19"][a][g][d][h]==1};

{SolHorarioProf} SolHorarioProfP35={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P35"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP36={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P36"][a][g][d][h]==1};

{SolHorarioProf} SolHorarioProfP45={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P45"][a][g][d][h]==1};

{SolHorarioProf} SolHorarioProfP50={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P50"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP54={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P54"][a][g][d][h]==1};


execute{
  //HORARIOS CURSOS
  writeln("Horario Departamentos =",SolHorarioDep);
  writeln("Horario Tutores =",SolHorarioTut);
  writeln("Horario Tutores =",SolHorarioGua);
  //ESO
  writeln("Horario 1º ESO A =",SolHorarioCurso1A);
  writeln("Horario 1º ESO B =",SolHorarioCurso1B);
  writeln("Horario 1º ESO Desdoble =",SolHorarioCurso1Desdoble);
  writeln("Horario 2º ESO A =",SolHorarioCurso2A);
  writeln("Horario 2º ESO B =",SolHorarioCurso2B);
  writeln("Horario 2º ESO PMAR =",SolHorarioCurso2PMAR);
  writeln("Horario 3º ESO PMAR =",SolHorarioCurso3PMAR);
  //BTO
  writeln("Horario 1º BTO A =",SolHorarioCurso1BTOA);
  writeln("Horario 1º BTO B =",SolHorarioCurso1BTOB);
  writeln("Horario 1º BTO C =",SolHorarioCurso1BTOC);
  writeln("Horario 1º BTO D =",SolHorarioCurso1BTOD);
  writeln("Horario 2º BTO A =",SolHorarioCurso2BTOA);
  writeln("Horario 2º BTO B =",SolHorarioCurso2BTOB);
  writeln("Horario 2º BTO C =",SolHorarioCurso2BTOC);
  writeln("Horario 2º BTO D =",SolHorarioCurso2BTOD);
  //HORARIOS PROFESORES
  writeln("Horario Profesor P1 =",SolHorarioProfP1);
  writeln("Horario Profesor P2 =",SolHorarioProfP2);
  writeln("Horario Profesor P3 =",SolHorarioProfP3);
  writeln("Horario Profesor P4 =",SolHorarioProfP4);
  writeln("Horario Profesor P5 =",SolHorarioProfP5);
  writeln("Horario Profesor P6 =",SolHorarioProfP6);
  writeln("Horario Profesor P7 =",SolHorarioProfP7);
  writeln("Horario Profesor P8 =",SolHorarioProfP8);
  writeln("Horario Profesor P9 =",SolHorarioProfP9);
  writeln("Horario Profesor P10 =",SolHorarioProfP10);
  writeln("Horario Profesor P11 =",SolHorarioProfP11);
  writeln("Horario Profesor P12 =",SolHorarioProfP12);
  writeln("Horario Profesor P13 =",SolHorarioProfP13);
  writeln("Horario Profesor P14 =",SolHorarioProfP14);
  writeln("Horario Profesor P15 =",SolHorarioProfP15);
  //Salto
  writeln("Horario Profesor P19 =",SolHorarioProfP19);
  //Salto
  writeln("Horario Profesor P35 =",SolHorarioProfP35);
  writeln("Horario Profesor P36 =",SolHorarioProfP36);
  //Salto
  writeln("Horario Profesor P45 =",SolHorarioProfP45);
  //Salto
  writeln("Horario Profesor P50 =",SolHorarioProfP50);
  //Salto
  writeln("Horario Profesor P54 =",SolHorarioProfP54);
}  
...
subject to
{
	...
	forall(p in Docentes, a in HorasAsignaturas, d in Dias, h in Hor: p not in DocTutores || a.nombre not in CursoTut || PrefTut[p][a.nombre]==0)
		x[p][a]["Tutores"][d][h]==0;
	// 2. Cada profesor sólo puede dar clases en aquellas asignaturas de las que tiene atribución docente.
	
	forall (g in Grup, a in HorasAsignaturas: RestriccionesAsignaturas[a][g]==1)
		sum(p in Docentes, d in Dias, h in Hor) x[p][a][g][d][h]==a.horas;
	// 3. Cada asignatura debe darse exactamente el número de horas que indica la ley.
   ...
   forall (g in Grup, d in Dias, h in Hor: g in Grup5HS){
	...
	// 5. Se dan todas las asignaturas optativas a la vez para cada grupo.
	...
	forall(d in Dias, h in Hor, a in HorasAsignaturas: a.nombre=="A125")
		sum(p in Docentes, g in Grup: g in Grup6CT || g in Grup6HS) x[p][a][g][d][h] == 4 || sum(p in Docentes, g in Grup: g in Grup6CT || g in Grup6HS) x[p][a][g][d][h] == 0;
	// 6. Las optativas deben darse a la vez en todos los grupos.
	...
	forall(g in Grup, d in Dias, h in Hor: g in GruposBase)
  	...
  	forall(g in Grup, d in Dias, h in Hor: g in GruposBase)
	  	sum(p in Docentes, a in HorasAsignaturas: a.nombre in OMarcas) x[p][a][g][d][h] <= 1;
	// 8y9. Sólo puede haber una asignatura (no optativa) por momento y varias dependiendo la optativa.
	 
	forall (g in Grup, a in HorasAsignaturas, d in Dias: g in GruposBase && a.nombre not in OptTriples && a.nombre not in CursoDep && a.nombre not in CursoTut) 
		sum(p in Docentes, h in Hor) x[p][a][g][d][h]<=1;
	// 10. Cada asignatura sólo se da una vez al día.
	...
	// 11y12. Las asignaturas de Desdoble deben darse a la misma hora en todos los grupos para que puedan salir los alumnos.
	  
	forall(p in Docentes)
	  sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][1]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][4]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][1]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][4]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][1]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][4]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][1]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][4]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][1]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][4]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Lunes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Martes"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Miercoles"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][0]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][0]==0||sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Jueves"][5]+ sum(a in HorasAsignaturas, g in Grup) x[p][a][g]["Viernes"][5]==0;
	 // 13. Horas puntas contrato: Las quito por ahora porque me hacen tardar el problema 40 min
	...
	forall(p in Docentes, d in Dias, h in Hor)
	  	sum(a in HorasAsignaturas, g in Grup) x[p][a][g][d][h] <= 4;
	// 4. Un profesor no puede estar en dos sitios a la vez
	 ...
	 forall(d in Dias, h in Hor){
  	...
  	// 14. Las asignaturas no se pueden pisar en un mismo aula o lugar
 	
 	forall(p in Docentes: p in DocTut)
 	  sum(d in Dias, h in Hor) x[p][<"ATUTP">]["Tutores"][d][h]==1;
 	// 15. Cada tutor debe tener una hora de atención a padres
	...
	forall(d in Dias, h in Hor)
	  	sum(p in Docentes) x[p][<"AGUA">]["Guardias"][d][h]==2;
	// 16y17. En cada momento debe haber dos profesores de guardia.
...
{SolHorarioProf} SolHorarioProfP1={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P1"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP2={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P2"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP3={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P3"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP4={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P4"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP5={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P5"][a][g][d][h]==1};
{SolHorarioProf} SolHorarioProfP6={<d,h+1,g,a.nombre>|d in Dias, h in Hor, g in Grup, a in HorasAsignaturas: x["P6"][a][g][d][h]==1};
